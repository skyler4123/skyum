...
class RDoc::AnyMethod < ::RDoc::MethodAttr
  ...
  # cannot be found.
  #
  # source://rdoc//rdoc/any_method.rb#122
  def is_alias_for; end

  # Dumps this AnyMethod for use by ri.  See also #marshal_load
  #
  # source://rdoc//rdoc/any_method.rb#140
  ...
  # * #parent_name
  #
  # source://rdoc//rdoc/any_method.rb#177
  ...
  #
  # source://rdoc//rdoc/any_method.rb#302
  def store=(store); end

  # For methods that +super+, find the superclass method that would be called.
  #
  # source://rdoc//rdoc/any_method.rb#311
  ...
  #
  # source://rdoc//rdoc/any_method.rb#330
  def _call_seq; end
  ...
  #
  # source://rdoc//rdoc/any_method.rb#340
...
class RDoc::Comment
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/comment.rb#144
  def empty?; end

  # HACK dubious
  #
  # source://rdoc//rdoc/comment.rb#151
  ...
  #
  # source://rdoc//rdoc/comment.rb#164
  def format=(format); end

  # source://rdoc//rdoc/comment.rb#169
  def inspect; end
  ...
  #
  # source://rdoc//rdoc/comment.rb#178
  def normalize; end
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/comment.rb#192
  def normalized?; end
  ...
  #    */
  #
  # source://rdoc//rdoc/comment.rb#221
  ...
  # @raise [RDoc::Error]
  #
  # source://rdoc//rdoc/comment.rb#235
  def text=(text); end
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/comment.rb#246
  def tomdoc?; end
...
class RDoc::CrossReference
  ...
  #
  # source://rdoc//rdoc/cross_reference.rb#187
  def resolve(name, text); end

  # source://rdoc//rdoc/cross_reference.rb#134
...
module RDoc::Encoding
  class << self
    ...
    # string
    #
    # source://rdoc//rdoc/encoding.rb#123
    def change_encoding(text, encoding); end

    # Detects the encoding of +string+ based on the magic comment
    #
    # source://rdoc//rdoc/encoding.rb#103
    ...
    # source://rdoc//rdoc/encoding.rb#89
    def remove_frozen_string_literal(string); end

    # Removes magic comments and shebang
    #
    # source://rdoc//rdoc/encoding.rb#113
...
class RDoc::Generator::POT
  ...
  # source://rdoc//rdoc/generator/pot.rb#84
  def class_dir; end
  ...
  # source://rdoc//rdoc/generator/pot.rb#89
...
class RDoc::Markdown::Literals
  ...
  #
  # source://rdoc//rdoc/markdown/literals.rb#18
  def initialize(str, debug = T.unsafe(nil)); end

  # Alphanumeric = /\p{Word}/
  #
  # source://rdoc//rdoc/markdown/literals.rb#406
  def _Alphanumeric; end

  # AlphanumericAscii = /[A-Za-z0-9]/
  #
  # source://rdoc//rdoc/markdown/literals.rb#413
  def _AlphanumericAscii; end

  # BOM = "uFEFF"
  #
  # source://rdoc//rdoc/markdown/literals.rb#420
  def _BOM; end

  # Newline = /\n|\r\n?|\p{Zl}|\p{Zp}/
  #
  # source://rdoc//rdoc/markdown/literals.rb#427
  def _Newline; end

  # NonAlphanumeric = /\p{^Word}/
  #
  # source://rdoc//rdoc/markdown/literals.rb#434
  def _NonAlphanumeric; end

  # Spacechar = /\t|\p{Zs}/
  #
  # source://rdoc//rdoc/markdown/literals.rb#441
  def _Spacechar; end

  # source://rdoc//rdoc/markdown/literals.rb#332
  def apply(rule); end

  # source://rdoc//rdoc/markdown/literals.rb#298
  def apply_with_args(rule, *args); end

  # source://rdoc//rdoc/markdown/literals.rb#80
  def current_character(target = T.unsafe(nil)); end

  # source://rdoc//rdoc/markdown/literals.rb#41
  def current_column(target = T.unsafe(nil)); end

  # source://rdoc//rdoc/markdown/literals.rb#64
  def current_line(target = T.unsafe(nil)); end

  # source://rdoc//rdoc/markdown/literals.rb#89
  def current_pos_info(target = T.unsafe(nil)); end

  # source://rdoc//rdoc/markdown/literals.rb#279
  def external_invoke(other, rule, *args); end

  # Returns the value of attribute failed_rule.
  #
  # source://rdoc//rdoc/markdown/literals.rb#201
  def failed_rule; end
  ...
  # source://rdoc//rdoc/markdown/literals.rb#148
  def failure_caret; end

  # source://rdoc//rdoc/markdown/literals.rb#153
  def failure_character; end

  # source://rdoc//rdoc/markdown/literals.rb#136
  def failure_info; end

  # source://rdoc//rdoc/markdown/literals.rb#157
  def failure_oneline; end

  # source://rdoc//rdoc/markdown/literals.rb#223
  def get_byte; end

  # source://rdoc//rdoc/markdown/literals.rb#101
  def get_line(no); end

  # source://rdoc//rdoc/markdown/literals.rb#115
  def get_text(start); end

  # source://rdoc//rdoc/markdown/literals.rb#365
  def grow_lr(rule, args, start_pos, m); end

  # source://rdoc//rdoc/markdown/literals.rb#97
  def lines; end

  # source://rdoc//rdoc/markdown/literals.rb#203
  def match_string(str); end

  # source://rdoc//rdoc/markdown/literals.rb#244
  def parse(rule = T.unsafe(nil)); end

  # Returns the value of attribute pos.
  #
  # source://rdoc//rdoc/markdown/literals.rb#39
  def pos; end
  ...
  # source://rdoc//rdoc/markdown/literals.rb#51
  def position_line_offsets; end

  # @raise [ParseError]
  #
  # source://rdoc//rdoc/markdown/literals.rb#171
  def raise_error; end
  ...
  # source://rdoc//rdoc/markdown/literals.rb#213
  def scan(reg); end

  # source://rdoc//rdoc/markdown/literals.rb#194
  def set_failed_rule(name); end

  # Sets the string and current parsing position for the parser.
  #
  # source://rdoc//rdoc/markdown/literals.rb#120
  def set_string(string, pos); end

  # :startdoc:
  # :stopdoc:
  #
  # source://rdoc//rdoc/markdown/literals.rb#403
  def setup_foreign_grammar; end

  # Prepares for parsing +str+.  If you define a custom initialize you must
  # call this method before #parse
  #
  # source://rdoc//rdoc/markdown/literals.rb#26
  def setup_parser(str, debug = T.unsafe(nil)); end

  # source://rdoc//rdoc/markdown/literals.rb#175
  def show_error(io = T.unsafe(nil)); end

  # source://rdoc//rdoc/markdown/literals.rb#127
  def show_pos; end
  ...
  class << self
    # source://rdoc//rdoc/markdown/literals.rb#396
    def rule_info(name, rendered); end
  end
end
...
class RDoc::Markdown::Literals::MemoEntry
  ...
  #
  # source://rdoc//rdoc/markdown/literals.rb#259
  ...
  #
  # source://rdoc//rdoc/markdown/literals.rb#268
  def left_rec; end
  ...
  # source://rdoc//rdoc/markdown/literals.rb#270
...
class RDoc::Markdown::Literals::RuleInfo
  ...
  #
  # source://rdoc//rdoc/markdown/literals.rb#388
  def initialize(name, rendered); end

  # Returns the value of attribute name.
  #
  # source://rdoc//rdoc/markdown/literals.rb#393
  def name; end
...
class RDoc::Markup::AttributeManager
  ...
  #   am.add_html 'em', :EM
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#283
  ...
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#295
  ...
  # @raise [ArgumentError]
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#258
  ...
  # character
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#153
  def convert_attrs(str, attrs, exclusive = T.unsafe(nil)); end

  # source://rdoc//rdoc/markup/attribute_manager.rb#158
  def convert_attrs_matching_word_pairs(str, attrs, exclusive); end

  # source://rdoc//rdoc/markup/attribute_manager.rb#182
  def convert_attrs_word_pair_map(str, attrs, exclusive); end

  # Converts HTML tags to RDoc attributes
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#203
  def convert_html(str, attrs, exclusive = T.unsafe(nil)); end

  # Converts regexp handling sequences to RDoc attributes
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#220
  ...
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#326
  def display_attributes; end

  # @return [Boolean]
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#141
  ...
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#304
  def flow(str); end
  ...
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#236
  ...
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#351
  def split_into_flow; end

  # Unescapes regexp handling sequences of text
  #
  # source://rdoc//rdoc/markup/attribute_manager.rb#248
...
# source://rdoc//rdoc/markup/attribute_manager.rb#145
...
class RDoc::Markup::Parser
  ...
  #
  # source://rdoc//rdoc/markup/parser.rb#464
  ...
  # @raise [ParseError]
  #
  # source://rdoc//rdoc/markup/parser.rb#473
  def skip(token_type, error = T.unsafe(nil)); end

  # Turns text +input+ into a stream of tokens
  #
  # source://rdoc//rdoc/markup/parser.rb#484
  ...
  # @raise [Error]
  #
  # source://rdoc//rdoc/markup/parser.rb#574
  def unget; end
...
class RDoc::Markup::Parser::MyStringScanner
  ...
  #
  # source://rdoc//rdoc/markup/parser.rb#423
  def initialize(input); end

  # source://rdoc//rdoc/markup/parser.rb#456
  def [](i); end

  # @return [Boolean]
  #
  # source://rdoc//rdoc/markup/parser.rb#448
  def eos?; end

  # source://rdoc//rdoc/markup/parser.rb#452
  def matched; end

  # source://rdoc//rdoc/markup/parser.rb#443
  def newline!; end

  # source://rdoc//rdoc/markup/parser.rb#439
  def pos; end

  # source://rdoc//rdoc/markup/parser.rb#428
  def scan(re); end

  # source://rdoc//rdoc/markup/parser.rb#434
  def unscan(s); end
end
...
class RDoc::Markup::Table
  ...
  #
  # source://rdoc//rdoc/markup/table.rb#8
  def initialize(header, align, body); end

  # source://rdoc//rdoc/markup/table.rb#12
  def ==(other); end

  # source://rdoc//rdoc/markup/table.rb#19
  def accept(visitor); end

  # Returns the value of attribute align.
  #
  # source://rdoc//rdoc/markup/table.rb#6
  def align; end
  ...
  # source://rdoc//rdoc/markup/table.rb#23
  def pretty_print(q); end
end
...
class RDoc::Markup::ToHtml < ::RDoc::Markup::Formatter
  ...
  #
  # source://rdoc//rdoc/markup/to_html.rb#288
  def accept_blank_line(blank_line); end

  # Adds +block_quote+ to the output
  #
  # source://rdoc//rdoc/markup/to_html.rb#189
  def accept_block_quote(block_quote); end

  # Adds +heading+ to the output.  The headings greater than 6 are trimmed to
  # level 6.
  #
  # source://rdoc//rdoc/markup/to_html.rb#296
  def accept_heading(heading); end

  # Finishes consumption of +list+
  #
  # source://rdoc//rdoc/markup/to_html.rb#259
  def accept_list_end(list); end

  # Finishes consumption of +list_item+
  #
  # source://rdoc//rdoc/markup/to_html.rb#281
  def accept_list_item_end(list_item); end

  # Prepares the visitor for consuming +list_item+
  #
  # source://rdoc//rdoc/markup/to_html.rb#270
  def accept_list_item_start(list_item); end

  # Prepares the visitor for consuming +list+
  #
  # source://rdoc//rdoc/markup/to_html.rb#250
  def accept_list_start(list); end

  # Adds +paragraph+ to the output
  #
  # source://rdoc//rdoc/markup/to_html.rb#202
  def accept_paragraph(paragraph); end

  # Adds +raw+ to the output
  #
  # source://rdoc//rdoc/markup/to_html.rb#317
  def accept_raw(raw); end

  # Adds +rule+ to the output
  #
  # source://rdoc//rdoc/markup/to_html.rb#243
  def accept_rule(rule); end

  # Adds +table+ to the output
  #
  # source://rdoc//rdoc/markup/to_html.rb#324
  def accept_table(header, body, aligns); end

  # Adds +verbatim+ to the output
  #
  # source://rdoc//rdoc/markup/to_html.rb#213
  ...
  # CGI-escapes +text+
  #
  # source://rdoc//rdoc/markup/to_html.rb#349
  def convert_string(text); end

  # Returns the generated output
  #
  # source://rdoc//rdoc/markup/to_html.rb#182
  ...
  #
  # source://rdoc//rdoc/markup/to_html.rb#357
  def gen_url(url, text); end

  # source://rdoc//rdoc/markup/to_html.rb#84
  def handle_RDOCLINK(url); end

  # +target+ is a <code><br></code>
  #
  # source://rdoc//rdoc/markup/to_html.rb#109
  ...
  #
  # source://rdoc//rdoc/markup/to_html.rb#125
  ...
  # @raise [RDoc::Error]
  #
  # source://rdoc//rdoc/markup/to_html.rb#382
  ...
  #
  # source://rdoc//rdoc/markup/to_html.rb#79
  def init_link_notation_regexp_handlings; end

  # Adds regexp handlings.
  #
  # source://rdoc//rdoc/markup/to_html.rb#69
  def init_regexp_handlings; end

  # Maps attributes to HTML tags
  #
  # source://rdoc//rdoc/markup/to_html.rb#391
  def init_tags; end
  ...
  #
  # source://rdoc//rdoc/markup/to_html.rb#417
  def list_end_for(list_type); end

  # Returns the HTML tag for +list_type+, possible using a label from
  # +list_item+
  #
  # source://rdoc//rdoc/markup/to_html.rb#401
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/markup/to_html.rb#431
  ...
  #
  # source://rdoc//rdoc/markup/to_html.rb#173
  def start_accepting; end

  # Converts +item+ to HTML using RDoc::Text#to_html
  #
  # source://rdoc//rdoc/markup/to_html.rb#443
...
#
# source://rdoc//rdoc/markup/to_html.rb#64
...
class RDoc::Markup::ToHtmlCrossref < ::RDoc::Markup::ToHtml
  ...
  #
  # source://rdoc//rdoc/markup/to_html_crossref.rb#60
  def cross_reference(name, text = T.unsafe(nil), code = T.unsafe(nil)); end

  # Generates links for <tt>rdoc-ref:</tt> scheme URLs and allows
  # RDoc::Markup::ToHtml to handle other schemes.
  #
  # source://rdoc//rdoc/markup/to_html_crossref.rb#130
  def gen_url(url, text); end
  ...
  #
  # source://rdoc//rdoc/markup/to_html_crossref.rb#82
  def handle_regexp_CROSSREF(target); end

  # Handles <tt>rdoc-ref:</tt> scheme links and allows RDoc::Markup::ToHtml to
  # handle other schemes.
  #
  # source://rdoc//rdoc/markup/to_html_crossref.rb#101
  def handle_regexp_HYPERLINK(target); end
  ...
  #
  # source://rdoc//rdoc/markup/to_html_crossref.rb#115
  def handle_regexp_RDOCLINK(target); end

  # source://rdoc//rdoc/markup/to_html_crossref.rb#45
  def init_link_notation_regexp_handlings; end

  # Creates an HTML link to +name+ with the given +text+.
  #
  # source://rdoc//rdoc/markup/to_html_crossref.rb#140
...
class RDoc::Markup::ToHtmlSnippet < ::RDoc::Markup::ToHtml
  ...
  # Finishes consumption of +list_item+
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#82
  def accept_list_item_end(list_item); end

  # Prepares the visitor for consuming +list_item+
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#88
  def accept_list_item_start(list_item); end

  # Prepares the visitor for consuming +list+
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#95
  def accept_list_start(list); end

  # source://rdoc//rdoc/markup/to_html_snippet.rb#69
  def accept_paragraph(paragraph); end
  ...
  # Adds +verbatim+ to the output
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#104
  def accept_verbatim(verbatim); end

  # Throws +:done+ when paragraph_limit paragraphs have been encountered
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#195
  ...
  # Marks up +content+
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#204
  def convert(content); end

  # Converts flow items +flow+
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#215
  def convert_flow(flow); end

  # Returns just the text of +link+, +url+ is only used to determine the link
  # type.
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#168
  def gen_url(url, text); end

  # Removes escaping from the cross-references in +target+
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#128
  def handle_regexp_CROSSREF(target); end

  # +target+ is a <code><br></code>
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#135
  def handle_regexp_HARD_BREAK(target); end

  # In snippets, there are no lists
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#188
  def html_list_name(list_type, open_tag); end

  # Lists are paragraphs, but notes and labels have a separator
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#143
  def list_item_start(list_item, list_type); end
  ...
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#261
  def off_tags(res, item); end

  # Maintains a bitmask to allow HTML elements to be closed properly.  See
  # RDoc::Markup::Formatter.
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#251
  def on_tags(res, item); end
  ...
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#119
  def start_accepting; end

  # Truncates +text+ at the end of the first word after the character_limit.
  #
  # source://rdoc//rdoc/markup/to_html_snippet.rb#270
...
class RDoc::Options
  ...
  # the files list.
  #
  # source://rdoc//rdoc/options.rb#600
  ...
  #
  # source://rdoc//rdoc/options.rb#619
  ...
  #
  # source://rdoc//rdoc/options.rb#645
  def parse(argv); end
  ...
  #
  # source://rdoc//rdoc/options.rb#1190
  def quiet; end

  # Set quietness to +bool+
  #
  # source://rdoc//rdoc/options.rb#1197
  def quiet=(bool); end
  ...
  #
  # source://rdoc//rdoc/options.rb#1204
  ...
  # default options.
  #
  # source://rdoc//rdoc/options.rb#1231
  ...
  #
  # source://rdoc//rdoc/options.rb#1253
  ...
  #
  # source://rdoc//rdoc/options.rb#1270
  def visibility=(visibility); end

  # Displays a warning using Kernel#warn if we're being verbose
  #
  # source://rdoc//rdoc/options.rb#1282
  ...
  # parsed options.
  #
  # source://rdoc//rdoc/options.rb#1290
  ...
  class << self
    ...
    # @raise [RDoc::Error]
    #
    # source://rdoc//rdoc/options.rb#1304
...
class RDoc::Parser::C < ::RDoc::Parser
  ...
  #
  # source://rdoc//rdoc/parser/c.rb#757
  def gen_const_table(file_content); end

  # Creates a new RDoc::Attr +attr_name+ on class +var_name+ that is either
  # +read+, +write+ or both
  #
  # source://rdoc//rdoc/parser/c.rb#829
  ...
  #
  # source://rdoc//rdoc/parser/c.rb#858
  ...
  # present.
  #
  # source://rdoc//rdoc/parser/c.rb#1064
  ...
  #
  # source://rdoc//rdoc/parser/c.rb#1093
...
module RDoc::Parser::ChangeLog::Git
  # source://rdoc//rdoc/parser/changelog.rb#247
  def create_entries(entries); end

  # source://rdoc//rdoc/parser/changelog.rb#225
  def parse_entries; end

  # source://rdoc//rdoc/parser/changelog.rb#220
  def parse_info(info); end
end

# source://rdoc//rdoc/parser/changelog.rb#256
...
class RDoc::Parser::ChangeLog::Git::LogEntry < ::Struct
  ...
  # source://rdoc//rdoc/parser/changelog.rb#283
  def label(context = T.unsafe(nil)); end

  # source://rdoc//rdoc/parser/changelog.rb#275
  def level; end

  # source://rdoc//rdoc/parser/changelog.rb#315
  def pretty_print(q); end

  # source://rdoc//rdoc/parser/changelog.rb#287
  def text; end
...
class RDoc::Parser::RipperStateLex
  ...
  #
  # source://rdoc//rdoc/parser/ripper_state_lex.rb#568
  ...
  # source://rdoc//rdoc/parser/ripper_state_lex.rb#460
  def get_embdoc_tk(tk); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#469
  def get_heredoc_tk(heredoc_name, indent); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#544
  def get_op_tk(tk); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#442
  def get_regexp_tk(tk); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#415
  def get_string_tk(tk); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#368
  def get_symbol_tk(tk); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#506
  def get_words_tk(tk); end

  # @return [Boolean]
  #
  # source://rdoc//rdoc/parser/ripper_state_lex.rb#494
  def heredoc_end?(name, indent, tk); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#488
  def retrieve_heredoc_info(tk); end

  class << self
    # @return [Boolean]
    #
    # source://rdoc//rdoc/parser/ripper_state_lex.rb#587
    def end?(token); end

    # source://rdoc//rdoc/parser/ripper_state_lex.rb#575
    def parse(code); end
  end
end
...
# source://rdoc//rdoc/parser/ripper_state_lex.rb#12
RDoc::Parser::RipperStateLex::EXPR_END = T.let(T.unsafe(nil), Integer)

# source://rdoc//rdoc/parser/ripper_state_lex.rb#13
RDoc::Parser::RipperStateLex::EXPR_ENDARG = T.let(T.unsafe(nil), Integer)

# source://rdoc//rdoc/parser/ripper_state_lex.rb#14
...
# source://rdoc//rdoc/parser/ripper_state_lex.rb#10
...
class RDoc::Parser::RipperStateLex::InnerStateLex < ::Ripper::Filter
  ...
  #
  # source://rdoc//rdoc/parser/ripper_state_lex.rb#308
  def initialize(code); end

  # source://rdoc//rdoc/parser/ripper_state_lex.rb#312
  def on_default(event, tok, data); end
end

# TODO: Remove this constants after Ruby 2.4 EOL
#
# source://rdoc//rdoc/parser/ripper_state_lex.rb#6
...
class RDoc::Parser::Ruby < ::RDoc::Parser
  ...
  #
  # source://rdoc//rdoc/parser/ruby.rb#233
  def collect_first_comment; end

  # Consumes trailing whitespace from the token stream
  #
  # source://rdoc//rdoc/parser/ruby.rb#276
  def consume_trailing_spaces; end

  # Creates a new attribute in +container+ with +name+.
  #
  # source://rdoc//rdoc/parser/ruby.rb#283
  ...
  #
  # source://rdoc//rdoc/parser/ruby.rb#297
  def create_module_alias(container, constant, rhs_name); end

  # Aborts with +msg+
  #
  # source://rdoc//rdoc/parser/ruby.rb#310
  def error(msg); end

  # Looks for a true or false token.
  #
  # source://rdoc//rdoc/parser/ruby.rb#319
  def get_bool; end
  ...
  # methods.
  #
  # source://rdoc//rdoc/parser/ruby.rb#205
  ...
  #
  # source://rdoc//rdoc/parser/ruby.rb#2091
  ...
  #
  # source://rdoc//rdoc/parser/ruby.rb#1194
  ...
  #   end
  #
  # source://rdoc//rdoc/parser/ruby.rb#1296
  def parse_meta_attr(context, single, tk, comment); end

  # Parses a meta-programmed method
  #
  # source://rdoc//rdoc/parser/ruby.rb#1330
  ...
  #
  # source://rdoc//rdoc/parser/ruby.rb#1569
  def parse_method_name_singleton(container, name_t); end

  # Extracts +yield+ parameters from +method+
  #
  # source://rdoc//rdoc/parser/ruby.rb#1613
  ...
  # of the current line.
  #
  # source://rdoc//rdoc/parser/ruby.rb#2128
...
class RDoc::RD::BlockParser < ::Racc::Parser
  ...
  #
  # source://rdoc//rdoc/rd/block_parser.rb#51
  def initialize; end

  # reduce 0 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#684
  def _reduce_1(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#726
  def _reduce_10(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#731
  def _reduce_11(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#736
  def _reduce_12(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#744
  def _reduce_13(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#750
  def _reduce_14(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#757
  def _reduce_15(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#762
  def _reduce_16(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#767
  def _reduce_17(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#778
  def _reduce_18(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#789
  def _reduce_19(val, _values, result); end

  # @raise [ParseError]
  #
  # source://rdoc//rdoc/rd/block_parser.rb#689
  def _reduce_2(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#795
  def _reduce_20(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#801
  def _reduce_21(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#807
  def _reduce_22(val, _values, result); end

  # reduce 26 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#823
  def _reduce_27(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#829
  def _reduce_28(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#835
  def _reduce_29(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#694
  def _reduce_3(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#841
  def _reduce_30(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#846
  def _reduce_31(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#851
  def _reduce_32(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#857
  def _reduce_33(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#862
  def _reduce_34(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#867
  def _reduce_35(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#873
  def _reduce_36(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#879
  def _reduce_37(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#884
  def _reduce_38(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#889
  def _reduce_39(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#699
  def _reduce_4(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#895
  def _reduce_40(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#901
  def _reduce_41(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#906
  def _reduce_42(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#911
  def _reduce_43(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#919
  def _reduce_44(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#925
  def _reduce_45(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#930
  def _reduce_46(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#935
  def _reduce_47(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#941
  def _reduce_48(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#947
  def _reduce_49(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#704
  def _reduce_5(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#953
  def _reduce_50(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#959
  def _reduce_51(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#965
  def _reduce_52(val, _values, result); end

  # reduce 53 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#972
  def _reduce_54(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#977
  def _reduce_55(val, _values, result); end

  # reduce 56 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#984
  def _reduce_57(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#709
  def _reduce_6(val, _values, result); end

  # reduce 61 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#997
  def _reduce_62(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1003
  def _reduce_63(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1009
  def _reduce_64(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1015
  def _reduce_65(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1021
  def _reduce_66(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1027
  def _reduce_67(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1032
  def _reduce_68(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1037
  def _reduce_69(val, _values, result); end

  # reduce 70 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#1044
  ...
  # reduce 7 omitted
  #
  # source://rdoc//rdoc/rd/block_parser.rb#716
  def _reduce_8(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#721
  def _reduce_9(val, _values, result); end

  # source://rdoc//rdoc/rd/block_parser.rb#1054
  def _reduce_none(val, _values, result); end

  # Adds footnote +content+ to the document
  #
  # source://rdoc//rdoc/rd/block_parser.rb#401
  def add_footnote(content); end

  # Adds label +label+ to the document
  #
  # source://rdoc//rdoc/rd/block_parser.rb#415
  def add_label(label); end

  # Retrieves the content of +values+ as a single String
  #
  # source://rdoc//rdoc/rd/block_parser.rb#384
  def content(values); end

  # Footnotes for this document
  #
  # source://rdoc//rdoc/rd/block_parser.rb#35
  def footnotes; end

  # Path to find included files in
  #
  # source://rdoc//rdoc/rd/block_parser.rb#45
  def include_path; end
  ...
  #
  # source://rdoc//rdoc/rd/block_parser.rb#40
  def labels; end

  # Current line number
  #
  # source://rdoc//rdoc/rd/block_parser.rb#339
  def line_index; end

  # Returns the next token from the document
  #
  # source://rdoc//rdoc/rd/block_parser.rb#107
  def next_token; end
  ...
  # @raise [ParseError]
  #
  # source://rdoc//rdoc/rd/block_parser.rb#323
  def on_error(et, ev, _values); end

  # Creates a paragraph for +value+
  #
  # source://rdoc//rdoc/rd/block_parser.rb#391
  def paragraph(value); end

  # Parses +src+ and returns an RDoc::Markup::Document.
  #
  # source://rdoc//rdoc/rd/block_parser.rb#63
  def parse(src); end
  ...
  #
  # source://rdoc//rdoc/rd/block_parser.rb#269
  def if_current_indent_equal(indent); end

  # Parses subtree +src+
  #
  # source://rdoc//rdoc/rd/block_parser.rb#346
  def parse_subtree(src); end

  # source://rdoc//rdoc/rd/block_parser.rb#314
  def set_term_to_element(parent, term); end
end

# source://rdoc//rdoc/rd/block_parser.rb#678
...
class RDoc::RD::InlineParser < ::Racc::Parser
  ...
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#90
  def initialize(block_parser); end

  # reduce 100 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1100
  def _reduce_101(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#1107
  def _reduce_102(val, _values, result); end

  # reduce 108 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1125
  def _reduce_109(val, _values, result); end

  # reduce 110 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1132
  def _reduce_111(val, _values, result); end

  # reduce 112 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1140
  def _reduce_113(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#1145
  def _reduce_114(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#1150
  def _reduce_115(val, _values, result); end

  # reduce 12 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#763
  def _reduce_13(val, _values, result); end

  # reduce 135 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1195
  def _reduce_136(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#770
  def _reduce_14(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#777
  def _reduce_15(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#784
  def _reduce_16(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#791
  def _reduce_17(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#799
  def _reduce_18(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#805
  def _reduce_19(val, _values, result); end

  # reduce 1 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#735
  def _reduce_2(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#813
  def _reduce_20(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#819
  def _reduce_21(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#828
  def _reduce_22(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#834
  def _reduce_23(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#840
  def _reduce_24(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#846
  def _reduce_25(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#855
  def _reduce_26(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#861
  def _reduce_27(val, _values, result); end

  # reduce 28 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#870
  def _reduce_29(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#740
  def _reduce_3(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#875
  def _reduce_30(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#880
  def _reduce_31(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#886
  def _reduce_32(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#892
  def _reduce_33(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#898
  def _reduce_34(val, _values, result); end

  # reduce 35 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#906
  def _reduce_36(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#911
  def _reduce_37(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#916
  def _reduce_38(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#922
  def _reduce_39(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#928
  def _reduce_40(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#934
  def _reduce_41(val, _values, result); end

  # reduce 42 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#942
  def _reduce_43(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#948
  def _reduce_44(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#954
  def _reduce_45(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#960
  def _reduce_46(val, _values, result); end

  # reduce 56 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#986
  def _reduce_57(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#992
  def _reduce_58(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#998
  def _reduce_59(val, _values, result); end

  # source://rdoc//rdoc/rd/inline_parser.rb#1004
  def _reduce_60(val, _values, result); end

  # reduce 61 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1011
  def _reduce_62(val, _values, result); end

  # reduce 63 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1019
  def _reduce_64(val, _values, result); end

  # reduce 77 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1051
  def _reduce_78(val, _values, result); end

  # reduce 137 omitted
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#1202
  def _reduce_none(val, _values, result); end

  # Creates a new RDoc::RD::Inline for the +rdoc+ markup and the raw +reference+
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#239
  def inline(rdoc, reference = T.unsafe(nil)); end

  # Returns the next token from the inline text
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#108
  def next_token; end

  # Returns words following an error
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#228
  ...
  #
  # source://rdoc//rdoc/rd/inline_parser.rb#216
  def last_line(src); end
end

# source://rdoc//rdoc/rd/inline_parser.rb#727
...
class RDoc::RI::Driver
  ...
  # searched for
  #
  # source://rdoc//rdoc/ri/driver.rb#998
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/ri/driver.rb#1315
  def paging?; end
  ...
  #
  # source://rdoc//rdoc/ri/driver.rb#1467
  def setup_pager; end

  # Show all method documentation following a class or module
  #
  # source://rdoc//rdoc/ri/driver.rb#61
  def show_all; end
  ...
  #
  # source://rdoc//rdoc/ri/driver.rb#1493
  def start_server; end

  # An RDoc::RI::Store for each entry in the RI path
  #
  # source://rdoc//rdoc/ri/driver.rb#66
  def stores; end
  ...
  #
  # source://rdoc//rdoc/ri/driver.rb#71
  def use_stdout; end
  ...
  class << self
    ...
    #
    # source://rdoc//rdoc/ri/driver.rb#76
    def default_options; end

    # Dump +data_path+ using pp
    #
    # source://rdoc//rdoc/ri/driver.rb#97
    def dump(data_path); end

    # Parses +argv+ and returns a Hash of options
    #
    # source://rdoc//rdoc/ri/driver.rb#108
    def process_args(argv); end

    # Runs the ri command line executable using +argv+
    #
    # source://rdoc//rdoc/ri/driver.rb#375
...
class RDoc::Store
  ...
  #
  # source://rdoc//rdoc/store.rb#209
  def all_classes; end

  # Returns all classes and modules discovered by RDoc
  #
  # source://rdoc//rdoc/store.rb#216
  def all_classes_and_modules; end

  # All TopLevels known to RDoc
  #
  # source://rdoc//rdoc/store.rb#223
  def all_files; end

  # Returns all modules discovered by RDoc
  #
  # source://rdoc//rdoc/store.rb#230
  def all_modules; end
  ...
  #
  # source://rdoc//rdoc/store.rb#239
  def ancestors; end

  # Attributes cache accessor.  Maps a class to an Array of its attributes.
  #
  # source://rdoc//rdoc/store.rb#246
  def attributes; end
  ...
  #
  # source://rdoc//rdoc/store.rb#253
  def cache_path; end

  # Path to the ri data for +klass_name+
  #
  # source://rdoc//rdoc/store.rb#260
  def class_file(klass_name); end

  # Class methods cache accessor.  Maps a class to an Array of its class
  # methods (not full name).
  #
  # source://rdoc//rdoc/store.rb#269
  def class_methods; end

  # Path where data for +klass_name+ will be stored (methods or class data)
  #
  # source://rdoc//rdoc/store.rb#276
  def class_path(klass_name); end

  # Hash of all classes known to RDoc
  #
  # source://rdoc//rdoc/store.rb#283
  def classes_hash; end

  # Removes empty items and ensures item in each collection are unique and
  # sorted
  #
  # source://rdoc//rdoc/store.rb#291
  ...
  #
  # source://rdoc//rdoc/store.rb#359
  def files_hash; end

  # Finds the enclosure (namespace) for the given C +variable+.
  #
  # source://rdoc//rdoc/store.rb#366
  def find_c_enclosure(variable); end

  # Finds the class with +name+ in all discovered classes
  #
  # source://rdoc//rdoc/store.rb#391
  def find_class_named(name); end

  # Finds the class with +name+ starting in namespace +from+
  #
  # source://rdoc//rdoc/store.rb#398
  def find_class_named_from(name, from); end

  # Finds the class or module with +name+
  #
  # source://rdoc//rdoc/store.rb#416
  def find_class_or_module(name); end

  # Finds the file with +name+ in all discovered files
  #
  # source://rdoc//rdoc/store.rb#424
  def find_file_named(name); end

  # Finds the module with +name+ in all discovered modules
  #
  # source://rdoc//rdoc/store.rb#431
  def find_module_named(name); end

  # Returns the RDoc::TopLevel that is a text file and has the given
  # +file_name+
  #
  # source://rdoc//rdoc/store.rb#439
  ...
  #
  # source://rdoc//rdoc/store.rb#744
  def remove_nodoc(all_hash); end

  # Saves all entries in the store
  #
  # source://rdoc//rdoc/store.rb#754
  def save; end

  # Writes the cache file for this store
  #
  # source://rdoc//rdoc/store.rb#779
  def save_cache; end

  # Writes the ri data for +klass+ (or module)
  #
  # source://rdoc//rdoc/store.rb#806
  def save_class(klass); end

  # Writes the ri data for +method+ on +klass+
  #
  # source://rdoc//rdoc/store.rb#880
  def save_method(klass, method); end

  # Writes the ri data for +page+
  #
  # source://rdoc//rdoc/store.rb#903
  ...
  #
  # source://rdoc//rdoc/store.rb#959
  def unique_classes; end

  # Returns the unique classes and modules discovered by RDoc.
  # ::complete must have been called prior to using this method.
  #
  # source://rdoc//rdoc/store.rb#967
  def unique_classes_and_modules; end

  # Returns the unique modules discovered by RDoc.
  # ::complete must have been called prior to using this method.
  #
  # source://rdoc//rdoc/store.rb#975
...
class RDoc::Task < ::Rake::TaskLib
  ...
  #
  # source://rdoc//rdoc/task.rb#171
  def check_names(names); end

  # Task description for the clobber rdoc task or its renamed equivalent
  #
  # source://rdoc//rdoc/task.rb#185
  def clobber_task_description; end

  # Sets default task values
  #
  # source://rdoc//rdoc/task.rb#192
  def defaults; end

  # Create the tasks defined by this task lib.
  #
  # source://rdoc//rdoc/task.rb#221
  def define; end

  # Whether to run the rdoc process as an external shell (default is false)
  #
  # source://rdoc//rdoc/task.rb#149
  def external; end
  ...
  #
  # source://rdoc//rdoc/task.rb#257
  def option_list; end

  # Additional list of options to be passed rdoc.  (default is [])
  #
  # source://rdoc//rdoc/task.rb#144
  def options; end
  ...
  #
  # source://rdoc//rdoc/task.rb#280
  def rdoc_task_description; end

  # Task description for the rerdoc task or its renamed description
  #
  # source://rdoc//rdoc/task.rb#287
  def rerdoc_task_description; end

  # Name of template to be used by rdoc. (defaults to rdoc's default)
  #
  # source://rdoc//rdoc/task.rb#128
  def template; end
  ...
  # source://rdoc//rdoc/task.rb#304
  def clobber_task_name; end

  # source://rdoc//rdoc/task.rb#293
  def rdoc_target; end

  # source://rdoc//rdoc/task.rb#297
  def rdoc_task_name; end

  # source://rdoc//rdoc/task.rb#311
...
module RDoc::Text
  ...
  #
  # source://rdoc//rdoc/text.rb#59
  def expand_tabs(text); end

  # Flush +text+ left based on the shortest line
  #
  # source://rdoc//rdoc/text.rb#78
  def flush_left(text); end

  # Returns the value of attribute language.
  #
  # source://rdoc//rdoc/text.rb#13
  def language; end
...
class RDoc::TopLevel < ::RDoc::Context
  ...
  #
  # source://rdoc//rdoc/top_level.rb#64
  def ==(other); end
  ...
  #
  # source://rdoc//rdoc/top_level.rb#73
  def add_alias(an_alias); end

  # Adds +constant+ to +Object+ instead of +self+.
  #
  # source://rdoc//rdoc/top_level.rb#82
  def add_constant(constant); end

  # Adds +include+ to +Object+ instead of +self+.
  #
  # source://rdoc//rdoc/top_level.rb#91
  def add_include(include); end

  # Adds +method+ to +Object+ instead of +self+.
  #
  # source://rdoc//rdoc/top_level.rb#100
  def add_method(method); end

  # Adds class or module +mod+. Used in the building phase
  # by the Ruby parser.
  #
  # source://rdoc//rdoc/top_level.rb#110
  def add_to_classes_or_modules(mod); end

  # Base name of this file
  #
  # source://rdoc//rdoc/top_level.rb#117
  def base_name; end
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/top_level.rb#127
  def display?; end
  ...
  #
  # source://rdoc//rdoc/top_level.rb#137
  def find_class_or_module(name); end

  # Finds a class or module named +symbol+
  #
  # source://rdoc//rdoc/top_level.rb#144
  def find_local_symbol(symbol); end

  # Finds a module or class with +name+
  #
  # source://rdoc//rdoc/top_level.rb#151
  def find_module_named(name); end

  # Returns the relative name of this file
  #
  # source://rdoc//rdoc/top_level.rb#158
  def full_name; end

  # An RDoc::TopLevel has the same hash as another with the same
  # relative_name
  #
  # source://rdoc//rdoc/top_level.rb#166
  def hash; end

  # URL for this with a +prefix+
  #
  # source://rdoc//rdoc/top_level.rb#173
  def http_url(prefix); end

  # source://rdoc//rdoc/top_level.rb#179
  def inspect; end

  # Time this file was last modified, if known
  #
  # source://rdoc//rdoc/top_level.rb#191
  def last_modified; end

  # Dumps this TopLevel for use by ri.  See also #marshal_load
  #
  # source://rdoc//rdoc/top_level.rb#198
  def marshal_dump; end

  # Loads this TopLevel from +array+.
  #
  # source://rdoc//rdoc/top_level.rb#210
  def marshal_load(array); end
  ...
  #
  # source://rdoc//rdoc/top_level.rb#224
  def object_class; end

  # Base name of this file without the extension
  #
  # source://rdoc//rdoc/top_level.rb#235
  def page_name; end
  ...
  # source://rdoc//rdoc/top_level.rb#55
  def parser=(val); end

  # Path to this file for use with HTML generator output.
  #
  # source://rdoc//rdoc/top_level.rb#245
  def path; end

  # source://rdoc//rdoc/top_level.rb#249
  def pretty_print(q); end
  ...
  # Search record used by RDoc::Generator::JsonIndex
  #
  # source://rdoc//rdoc/top_level.rb#263
  def search_record; end
  ...
  # @return [Boolean]
  #
  # source://rdoc//rdoc/top_level.rb#280
  def text?; end

  # source://rdoc//rdoc/top_level.rb#284
  def to_s; end
end
