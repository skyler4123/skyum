...
# Please instead update this file by running `bin/tapioca dsl OrderProduct`.
...
class OrderProduct
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::OrderProduct).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::OrderProduct).void)
    ...
    sig { returns(T::Array[::OrderProduct]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::OrderProduct)) }
    def fifth; end

    sig { returns(::OrderProduct) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::OrderProduct)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::OrderProduct) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::OrderProduct).void)
      ).returns(T.nilable(T::Enumerator[::OrderProduct]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::OrderProduct]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::OrderProduct]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::OrderProduct)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::OrderProduct) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::OrderProduct) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::OrderProduct, T::Enumerable[T.any(::OrderProduct, T::Enumerable[::OrderProduct])])
    ...
    sig do
      params(
        records: T.any(::OrderProduct, Integer, String, T::Enumerable[T.any(::OrderProduct, Integer, String, T::Enumerable[::OrderProduct])])
      ).returns(T::Array[::OrderProduct])
    end
    ...
    sig do
      params(
        other_array: T.any(::OrderProduct, T::Enumerable[T.any(::OrderProduct, T::Enumerable[::OrderProduct])])
      ).returns(T::Array[::OrderProduct])
    end
