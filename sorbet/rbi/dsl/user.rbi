...
class User
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :customers`.
    ...
    sig { returns(T::Array[T.untyped]) }
    def shop_owner_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def shop_owner_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :shop_owners`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::ShopOwner::PrivateCollectionProxy) }
    def shop_owners; end

    sig { params(value: T::Enumerable[::ShopOwner]).void }
    def shop_owners=(value); end
  end
