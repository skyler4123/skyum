...
class Order
  ...
  module CommonRelationMethods
    ...
    sig do
      ...
      ).returns(T.nilable(T::Enumerator[::Order]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Order]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Order]]))
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Order` class because it declared `has_many :order_products`.
    ...
    # This method is created by ActiveRecord on the `Order` class because it declared `has_many :products, through: :order_products`.
